...
public class Maths {
    ...
    public static Matrix4f createTransMat(Vector3f translation, float rX, float rY, float rZ, float scale){
        Matrix4f matrix = new Matrix4f();
        matrix.identity();
        matrix.translate(translation.x, translation.y, translation.z);
        matrix.rotate((float)Math.toRadians(rX), 1.0f, 0.0f, 0.0f, matrix);
        matrix.rotate((float)Math.toRadians(rY), 0.0f, 1.0f, 0.0f, matrix);
        matrix.rotate((float)Math.toRadians(rZ), 0.0f, 0.0f, 1.0f, matrix);
