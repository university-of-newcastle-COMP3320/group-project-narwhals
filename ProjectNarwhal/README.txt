...
The external libraries for LWJGL may not be loaded. The required libraries are in the git folder "EIxternalLWIGLLibraries".
If these libraries are not loaded, go to intellj IDEA File > Project Structure > Libraries and select the + sign and select java.
